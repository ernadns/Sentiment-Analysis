data=read.csv("E:/KULIAH/TUGAS AKHIR LJ/FULL TWEET/DATA UNTUK BRI TANPA REPLIES/datauntuksmoteBRI.csv", sep=",", dec=".")
X=subset(data,select=-c(y))
target=subset(data,select=c(y))
library(smotefamily)
K=3
dup_size=40
#-------------------------------------------------------------
...
write.csv(syn_dat, "E:/KULIAH/TUGAS AKHIR LJ/FULL TWEET/DATA UNTUK MANDIRI TANPA REPLIES/data sintetik smote1.csv")
write.csv(newD, "E:/KULIAH/TUGAS AKHIR LJ/FULL TWEET/DATA UNTUK MANDIRI TANPA REPLIES/data smote1.csv")
